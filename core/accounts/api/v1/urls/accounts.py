...
from ..views import (
    ...
    ActivationResendGenericAPIView,
)
...
urlpatterns = [
    ...
    path(
        ...
        ActivationConfirmGenericAPIView.as_view(),
        name="activation-confirm",
    ),
    path(
        "activation/resend/",
        ActivationResendGenericAPIView.as_view(),
    ...
    path(
        "jwt/verify/", TokenVerifyView.as_view(), name="jwt_verify"
    ),
]
